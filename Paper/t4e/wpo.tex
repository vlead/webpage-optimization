...
\begin{itemize}
\item From the graph below, we can observe that only 1 web page is having good
performance.Rest web pages are not in good condition.They really need to be
optimized.Out of rest,687 i.e 13\% webpages are in above average conditions,1038
webpages are performing average and rest 3220 webpages are not in good
condition.These all statistics are showing that these pages are not following
performance best practices.  
\begin{figure}[ht]
 \centering
$\includegraphics[scale=0.27]{img/vlab+/Overall_Score.jpg}$
...
\begin{figure}[ht]
 \centering
$\includegraphics[scale=0.35]{img/vlab+/Overall_Score.jpg}$
\caption{Number of urls versus Overscore}
\end{figure}

\begin{figure}[ht]
 \centering
$\includegraphics[scale=0.27]{img/vlab+/Put-CSS-at-top.jpg}$
\caption{Number of urls versus Overscore}
\end{figure}
...
\section{Graphs for deploy.virtual-labs.ac.in}
\begin{figure}[ht]
 \centering
$\includegraphics[scale=0.27]{img/vlab+/Overall_Score.jpg}$
\caption{Number of urls versus Overscore}
